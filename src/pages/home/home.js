...
function Home() {
  ...
  // Add a rootMargin to trigger the animation earlier
  const isTextSectionInView = useInView(textSectionRef, {
    once: true,
    rootMargin: '-100px 0px', // 100px margin from the top and bottom
  });
      ...
      >
        ...
        <div className="watwedoen-block">
          ...
          <div className="watwedoen-content">
            ...
            <button className="watwedoen-button" href="#watwedoen">WAT WE DOEN</button>
          </div>
        </div>
